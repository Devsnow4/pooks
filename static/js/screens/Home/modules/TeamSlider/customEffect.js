...
import {
    getSlideTransformEl
} from '../../../../../node_modules/swiper/shared/utils.js';

export default function EffectCustom({
    swiper,
    extendParams,
    on
}) {
    ...
    const setTranslate = () => {
        ...
        for (let i = 0; i < slides.length; i += 1) {
            ...
            const progress = isMobile ?
                Math.min(Math.max(slideProgress, -1), 1) :
                Math.min(Math.max(slideProgress, -2), 2);
